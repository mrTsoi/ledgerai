      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">{lt('About LedgerAI')}</h1>
            <p className="mt-4 text-lg text-gray-600">
              {lt('LedgerAI is a multi-tenant accounting platform designed to automate bookkeeping workflows while preserving control, auditability, and tenant isolation.')}
            </p>
