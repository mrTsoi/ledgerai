      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              View revenue and expenses for a period
            </CardDescription>
          </div>
                ...
                <table className="w-full">
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-gray-300 bg-green-50">
                      <td colSpan={2} className="py-2 px-4 font-semibold">Total Revenue</td>
                ...
                <table className="w-full">
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-gray-300 bg-red-50">
                      <td colSpan={2} className="py-2 px-4 font-semibold">Total Expenses</td>
