...
export function TrialBalanceReport() {
  ...
  const exportToCSV = () => {
    const headers = ['Account Code', 'Account Name', 'Type', 'Subtype', 'Debit', 'Credit', 'Balance']
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              View all account balances to verify debits equal credits
            </CardDescription>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {startDate ? format(new Date(startDate), 'MMM dd, yyyy') : 'All Time'} - {format(new Date(endDate), 'MMM dd, yyyy')}
                  </p>
                </div>
                <div>
